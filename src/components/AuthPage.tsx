  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-background">
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 px-6">
        <div className="glass-panel p-8 w-full max-w-sm space-y-5">
          ...
          <Button
            ...
            className="w-full h-11 rounded-xl border-border/50 bg-muted/30 hover:bg-muted/50 font-medium transition-all"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-card/50 px-3 text-muted-foreground">or continue with email</span></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <Button type="submit" disabled={loading} className="w-full h-11 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 font-medium mt-1 transition-all">
              {loading ? (

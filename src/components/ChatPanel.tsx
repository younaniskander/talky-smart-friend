...
export function ChatPanel() {
  const { messages, isLoading, send, stop, clear, conversationId, setActiveConversation } = useChat("chat");
  ...
  return (
    <div className="flex h-full">
      {/* Sidebar */}
      <div className="w-64 border-r border-border/30 hidden md:flex flex-col bg-card/30">
          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground max-w-sm">Your AI assistant. Ask me anything or try voice input.</p>
              </div>
            </div>
          )}
